...
% 
% Syntax:
%     [t, y] = euler_backward(funz, intervallo, y0, ninterval)
% 
% Input Arguments:
%     funz      - Function handle representing the ODE dy/dt = f(t,y)
%     intervallo - 2-element vector [t0, tend] specifying integration interval
...
function [t, y] = euler_backward(funz, interval, y0, ninterval)
