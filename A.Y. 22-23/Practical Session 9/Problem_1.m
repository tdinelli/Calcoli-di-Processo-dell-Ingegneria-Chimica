...
q = @(t) (2 .* (sin((t./24).*pi).^2)).*60; % [L/h]
total_time = 24; % h
time = 0:0.0001:total_time*2; % h
t = 1:1:49;
tt = 0:1:24;
%% Solution
...
tic
I4 = trapezoidal_Ait(q,0,24,1000);
toc
...
xlim([0 48])
legend('Volumetric Rate [L/h]', 'Volume [L]', 'FontSize', 18,'location', 'northwest')